//https://teachablemachine.withgoogle.com/models/NKYocqsXQ/
prediction_1="";
prediction_2="";
Webcam.set({
    width: 350,
...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/NKYocqsXQ/model.json', modelLoaded);
...
if(error){
   ...
   doccument.getElementById("update_emoji_1").innerHTML="";
